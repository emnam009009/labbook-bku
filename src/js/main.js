...
// [LAZY] reports page imported on-demand via pageChange event listener
...
// [LAZY] window.renderReports set after dynamic import
...
const _pageLoaders = {
  ...
  reports: async () => {
    const m = await import('./pages/reports.js');
    window.renderReports = m.renderReports;
